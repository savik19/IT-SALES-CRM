# Sales CRM — Build Brief

> This file is the source of truth for building the in-house Sales CRM frontend.
...
and keep data-fetching isolated in small functions, so the backend dev can swap mock → API in
...
- **Brand colour (primary):** `#1060E0` (Brand blue). Use for primary buttons, active
